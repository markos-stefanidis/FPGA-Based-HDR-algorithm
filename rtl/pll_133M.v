...
/* Module Version: 5.7 */
/* C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n pll_133M -lang verilog -synth synplify -arch ep5a00 -type pll -fin 100 -phase_cntl STATIC -fclkop 133 -fclkop_tol 10.0 -delay_cntl AUTO_NO_DELAY -fb_mode CLOCKTREE -extcap DISABLED -noclkos -noclkok -norst  */
/* Thu Feb 17 18:12:53 2022 */


`timescale 1 ns / 1 ps
module pll_133M (CLK, CLKOP, LOCK)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLK;
    output wire CLKOP;
    output wire LOCK;
